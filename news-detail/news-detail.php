...
<link rel="stylesheet" href="/news-detail/style.css">
...
<div class="content-container">
    <h1 class="heading-1 detail-news__title">Шесть памятных монет выпущенных банком России получили награды XV международного конкурса памятных монет “Монетное созвездие - 2021”</h1>
    ...
    <?
        ...
        {?>
            ...
            <div class="dark-wrapper">
                <? require $_SERVER["DOCUMENT_ROOT"]."/components/news-list/linked-news-detail-news/template.php"; ?>
            </div>
        <?}
    ?>
</div>
