<link rel="stylesheet" href="/components/news-list/coins-slider-3-row/style.css">
<script src="/components/news-list/coins-slider-3-row/script.js" defer></script>
                ...
                <div class="mobile-needed-wrapper">
                    ...
                    <div class="coin-item__description-wrapper">
                        ...
                        <div class="bottom-bar">
                            ...
                            <button class="add-to-cart">
                                <img src="/images/icons/app-footer/shopping-cart.svg" alt="звонок">
                            </button>
                        </div>
                    </div>
                </div>
