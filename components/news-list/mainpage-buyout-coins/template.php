...
<section class="buyout-coins">
    <div class="buyout-coins__title-navigation-wrapper">
        <h2 class="heading-3 buyout-coins__title">Выкуп монет</h2>

        <div class="mobile-buyout-coins-slider-nav">
    ...
    <div class="swiper buyout-coins-slider">
        ...
        <div class="desktop-buyout-coins-nav-wrapper">
            <button class="swiper-button-prev">
                <img src="/images/icons/linked-coins/slider-arrow.svg" alt="стрелка влево">    
            <button>
